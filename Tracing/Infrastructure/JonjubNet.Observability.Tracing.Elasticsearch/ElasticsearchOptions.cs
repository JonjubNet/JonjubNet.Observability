...
{
    /// <summary>
    /// Opciones de configuración para el exporter de Elasticsearch para Tracing
    /// Similar a ElasticsearchOptions de Logging pero para traces/spans
    /// </summary>
    public class ElasticsearchOptions
    {
        ...
        /// </summary>
        public string IndexName { get; set; } = "traces";
