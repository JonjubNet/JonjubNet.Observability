...
{
    /// <summary>
    /// Opciones de configuración para el sink de Kafka para Tracing
    /// Similar a KafkaOptions de Logging pero para traces/spans
    /// </summary>
    public class KafkaOptions
    {
        ...
        /// Topic de Kafka
        /// </summary>
        public string Topic { get; set; } = "traces";
