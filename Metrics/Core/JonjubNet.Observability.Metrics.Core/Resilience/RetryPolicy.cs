...
namespace JonjubNet.Observability.Metrics.Core.Resilience
{
    ...
    public class RetryPolicy
    {
        ...
        {
            Exception? lastException = null;
            // Nota: No podemos usar CollectionPool para List<RetryAttempt> porque no está en el pool
            // Pero podemos optimizar pre-allocando capacidad basada en maxRetries
