...
{
    /// <summary>
    /// Opciones de configuración para el sink HTTP para Metrics
    /// Similar a HttpOptions de Logging pero para métricas
    /// </summary>
    public class HttpOptions : MetricsSinkOptions
    {
        /// <summary>
        /// URL del endpoint HTTP
        /// </summary>
        public string EndpointUrl { get; set; } = "http://localhost:8080/metrics";
